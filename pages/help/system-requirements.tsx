...
const StstemRequirements = () => {
  return (
    <div className=" flex flex-col items-center justify-center w-full h-full gap-y-5">
      ...
      <div className=" w-2/3 h-1/2 bg-white rounded-[15px]  px-[100px] p-[30px] py-5 text-justify text-[14px] font-normal text-black gap-y-5 flex flex-col overflow-y-scroll">
