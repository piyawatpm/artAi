    ...
    <div className=" flex flex-col items-center justify-center w-full h-full gap-y-5">
      ...
      <div className=" w-2/3 h-1/2 bg-white rounded-[15px]  p-[30px] py-5 text-justify text-[14px] font-normal text-black gap-y-5 flex flex-col overflow-y-scroll">
        ...
        <ul className="list-disc">
            <li>Go to the Artsai website : https://www.artsai.io/sign-in</li>
            <li>Click on the "Sign Up" button located in the top right corner of the homepage.</li>
            <li>Fill in the required information such as your email address and a secure password. You can also choose to sign up with your Google, Facebook or Twitter account</li>
            <li>Click on the "Create Account" button.</li>
            <li>You will receive a confirmation email. Click on the confirmation link in the email to activate your Artsai account.</li>
            <li>After you have created your account, you can log in and start exploring the platform.</li>
        </ul>
      </div>
    </div>
  );
